...
```shell
$ java -cp target/xrpc-0.1.0-SNAPSHOT.jar com.xjeffrose.nsfs.DinoEncoder trex blue > out
$ java -cp target/xrpc-0.1.0-SNAPSHOT.jar com.xjeffrose.nsfs.DinoDecoder < out
...
```shell
$ java -cp target/xrpc-0.1.0-SNAPSHOT.jar com.xjeffrose.nsfs.DinoEncoder trex blue | curl -k  https://localhost:8080/dinos/trex --data-binary @-
```

# Proto http get

```shell
$ curl -k -s   https://localhost:8080/dinos/ | java -cp target/xrpc-0.1.0-SNAPSHOT.jar com.xjeffrose.nsfs.DinoDecoder
Dino{name=trex, fav_color=blue}
```
